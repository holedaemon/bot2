...
var QuoteWhere = struct {
	...
	QuoterID:       whereHelpernull_String{field: "\"quotes\".\"quoter_id\""},
...
var (
	...
	quoteColumnsWithoutDefault = []string{"quote", "num", "quoted_id", "quoted_username", "guild_id", "channel_id", "message_id"}
	quoteColumnsWithDefault    = []string{"id", "quoter_id", "created_at", "updated_at"}
