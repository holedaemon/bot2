...
var EgoraptorMentionWhere = struct {
	...
	UserID:    whereHelperstring{field: "\"egoraptor_mentions\".\"user_id\""},
...
var (
	egoraptorMentionAllColumns            = []string{"id", "guild_id", "user_id", "count", "created_at", "updated_at"}
	egoraptorMentionColumnsWithoutDefault = []string{"guild_id", "user_id", "count"}
	egoraptorMentionColumnsWithDefault    = []string{"id", "created_at", "updated_at"}
